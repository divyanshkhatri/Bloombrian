...
class Hompage extends Component {
        ...
        .then((value) => {
            ...
            .then((response) => {
                if(response.ok){
                    ...
                    if(response.status == 404) {
                        this.setState({isLoading: false});
                        this.setState({statusProfile: 404});
                        console.log("404");
                    }
                    if(response.status == 500) {
                        this.setState({isLoading: false});
                        this.setState({statusProfile: 500});
                        console.log("500");
                    }
                }
            ...
            .then((response) => {
                if(response.ok) 
                    ...
                    if(response.status == 404) {
                        this.setState({statusPicks: 404});
                        this.setState({isLoading: false});
                        console.log("404");
                    }
                    if(response.status == 500) {
                        this.setState({statusPicks: 500});
                        this.setState({isLoading: false});
                        console.log("500");
                    }
                }
    ...
    get paginationCategories () {
        const { categories, activeIndexCategories } = this.state;
        return (
            <Pagination
                containerStyle = {{
                    alignItems: 'center',
                ...
                dotsLength={categories ? categories.length : 0}
                activeDotIndex={activeIndexCategories}
                //   containerStyle={{ backgroundColor: 'rgba(0, 0, 0, 0.75)' }}
                dotStyle={{
                    width: 9,
                    height: 9,
            ...
            style = {{
                ...
                {this.state.isLoading ?  
                   ( 
                    ...
                    !this.state.isLoading && this.state.statusPicks == 200 && this.state.statusProfile == 200 ? 
                    (
                        ...
                        <TouchableWithoutFeedback onPress = {() => {
                            ...
                            <View 
                                ...
                                style = {{
                                    ...
                                    borderRadius: Platform.isPad ? 30 : 20,
                                    borderColor: '#32C6F3',
                                    borderWidth: 1
                                ...
                                style = {{
                                    fontFamily : "Poppins-Bold",
                                    fontSize: Platform.isPad ? 20 : Platform.OS == "android" ? 12 : 14,
                                    color: 'white',
                                ...
                                style = {{
                                    ...
                                    fontSize: Platform.isPad ? 15 : Platform.OS == "android" ? 10 : 11,
                                    color: '#707070',
                                    height: 40,
                                }}
                        ...
                        <View style = {{
                            ...
                            {
                                this.state.carouselItems != undefined ?    
                                <Carousel
                                    layout={"default"}
                                    ...
                                    (
                                        <TouchableWithoutFeedback onPress = {() => { 
                                            ...
                                            <View style = {{
                                                ...
                                                >
                                                    <Image
                                                        source = {(/^(?:\w+:)?\/\/([^\s\.]+\.\S{2}|localhost[\:?\d]*)\S*$/.test(item["thumbnail_url"] )== false) ? require("../images/picks1.jpeg") : {uri: item["thumbnail_url"]}}
                        ...
                        style = {{
                            ...
                            fontFamily : "Poppins-Bold",
                            fontSize: 18,
                            textAlign: Platform.isPad ? "left" : "left",
                            color: 'white',
                            marginBottom: 20,
                            marginTop: Platform.OS == "android" ? 0 : 0
                        }}>
                        ...
                        <Carousel
                            ...
                            onSnapToItem = { index => this.setState({activeIndexCategories:index})}
                        />
                        {this.paginationCategories}
                    </ScrollView>
                    )
                    : (!this.state.isLoading && (this.state.statusProfile == 500 || this.state.statusPicks == 500)) ? 
                    (
                        <View>
                            <Modal500 />
                        </View>
                    )
                    : (!this.state.isLoading && (this.state.statusProfile == 404 || this.state.statusPicks == 404)) ?
                    (
                        <View>
                            <Modal404 />
                        </View>
